pragma solidity =0.6.0 0.7.0;
 ...
 import ownable
import httpsgithub.comOpenZeppelinopenzeppelin-contractsblobmastercontractsaccessOwnable.sol;
...
contract garbageTaxes is Ownable {
    ...
    function computeTaxes() public view returns (uint) {
        ...
        uint taxes = totalNonRecyclableWaste10 + totalRecyclableWaste100;
        return taxes;
    }
